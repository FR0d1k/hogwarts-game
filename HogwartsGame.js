...
// include: C:\Users\Laptop\AppData\Local\Temp\tmpv1xu_t6l.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'HogwartsGame.data';
      var REMOTE_PACKAGE_BASE = 'HogwartsGame.data';
...
Module['FS_createPath']("/", "assets", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_HogwartsGame.data');
      }
      Module['addRunDependency']('datafile_HogwartsGame.data');
    ...
    loadPackage({"files": [{"filename": "/assets/Defeat.mp3", "start": 0, "end": 117548}, {"filename": "/assets/Ekran.mp3", "start": 117548, "end": 6748722}, {"filename": "/assets/Golova.mp3", "start": 6748722, "end": 102201566}, {"filename": "/assets/Golova.png", "start": 102201566, "end": 103166539}, {"filename": "/assets/HarryPotter.ttf", "start": 103166539, "end": 103191695}, {"filename": "/assets/Menu.jpg", "start": 103191695, "end": 103320376}, {"filename": "/assets/Menu.png", "start": 103320376, "end": 103998561}, {"filename": "/assets/NaSvoem.png", "start": 103998561, "end": 104003986}, {"filename": "/assets/NeNaSvoem.png", "start": 104003986, "end": 104010984}, {"filename": "/assets/Net.png", "start": 104010984, "end": 104017344}, {"filename": "/assets/OpenPismo.png", "start": 104017344, "end": 104024763}, {"filename": "/assets/Pismo.png", "start": 104024763, "end": 104037613}, {"filename": "/assets/Victory.mp3", "start": 104037613, "end": 104114457}], "remote_package_size": 104114457});

  })();

// end include: C:\Users\Laptop\AppData\Local\Temp\tmpv1xu_t6l.js
// include: C:\Users\Laptop\AppData\Local\Temp\tmpycy7kzo8.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\Laptop\AppData\Local\Temp\tmpycy7kzo8.js
// include: C:\Users\Laptop\AppData\Local\Temp\tmpaf7uycr5.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\Laptop\AppData\Local\Temp\tmpaf7uycr5.js
...
function findWasmBinary() {
  return locateFile('HogwartsGame.wasm');
}
...
var ASM_CONSTS = {
  141094: () => { if (document.fullscreenElement) return 1; },  
 141140: () => { return Module.canvas.width; },  
 141172: () => { return parseInt(Module.canvas.style.width); },  
 141220: () => { document.exitFullscreen(); },  
 141247: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 141319: () => { if (document.fullscreenElement) return 1; },  
 141365: () => { return Module.canvas.width; },  
 141397: () => { return screen.width; },  
 141422: () => { document.exitFullscreen(); },  
 141449: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 141643: () => { return window.innerWidth; },  
 141669: () => { return window.innerHeight; },  
 141696: () => { if (document.fullscreenElement) return 1; },  
 141742: () => { return Module.canvas.width; },  
 141774: () => { return parseInt(Module.canvas.style.width); },  
 141822: () => { if (document.fullscreenElement) return 1; },  
 141868: () => { return Module.canvas.width; },  
 141900: () => { return screen.width; },  
 141925: () => { return window.innerWidth; },  
 141951: () => { return window.innerHeight; },  
 141978: () => { if (document.fullscreenElement) return 1; },  
 142024: () => { return Module.canvas.width; },  
 142056: () => { return screen.width; },  
 142081: () => { document.exitFullscreen(); },  
 142108: () => { if (document.fullscreenElement) return 1; },  
 142154: () => { return Module.canvas.width; },  
 142186: () => { return parseInt(Module.canvas.style.width); },  
 142234: () => { document.exitFullscreen(); },  
 142261: ($0) => { Module.canvas.style.opacity = $0; },  
 142299: () => { return screen.width; },  
 142324: () => { return screen.height; },  
 142350: () => { return window.screenX; },  
 142377: () => { return window.screenY; },  
 142404: () => { return window.devicePixelRatio; },  
 142440: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 142493: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 142544: () => { Module.canvas.style.cursor = 'none'; },  
 142581: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 142837: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 142888: () => { if (document.pointerLockElement) return 1; },  
 142935: () => { if (document.fullscreenElement) return 1; },  
 142981: () => { return window.innerWidth; },  
 143007: () => { return window.innerHeight; },  
 143034: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; let miniaudio = window.miniaudio; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === miniaudio.device_state.started) { device.webaudio.resume().then(() => { _ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 145212: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, window.miniaudio.unlock, true); }); window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 145516: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 145620: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 ...
 148668: ($0) => { return window.miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 148741: ($0) => { var device = window.miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 149141: ($0) => { window.miniaudio.untrack_device_by_index($0); },  
 149191: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = window.miniaudio.device_state.started; },  
 149330: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; }
};
